...
"""
Full model with degradation-type inhibition.

All 59 parameters free for initial fitting.
After analyzing per-condition fits, CD3/CD28 parameters can be constrained.

Parameters: 59 total
- Basal production: 4
- Basal degradation: 4
- Interaction k: 32 (k1-k32)
- Hill K: 9
- Hill h: 9
...
class FullModel_4_SD(BaseTcellModel):
    """
    Full 59-parameter model with Hill functions.
    ...
    def forward(self, t, y):
        ...
        # DEGRADATION style: negative terms multiply by species
        dIL2 = (
            k_prod[:, 0]
    ...
    def params_to_model(positions, model):
        ...
        assert idx == 59, f"Expected 59 parameters, got {idx}"