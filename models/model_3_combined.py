...
class CombinedModel_3_S(BaseTcellModel):
    
    """
    Full model actting exclusively on sythesis terms.
    """
    
    model_name = "Combined Model - S"
    ...
    def forward(self, t, y):
        ...
        dIL4 = (
            ...
            - k23 * self.cd3 - k27 * IL2 * H_act_CD28_k27
            - k29 * IL21- k31 * IFNg - k32 * IL12_eff
            - k_deg[:, 3] * IL4
        )
